        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-white/90 leading-8 mb-6">
              This certificate verifies that the Threestones fire has been
              installed and is operational. it is agreed by the buyer and seller
              who estimate the carbon reduction of 1 CO2e per annum.
            </p>
